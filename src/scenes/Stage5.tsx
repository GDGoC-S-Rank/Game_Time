  ...
  return (
    <div className="stage5-container">
      ...
      <img
        src={control_panel}
        alt="control_panel"
        className="stage5_control_panel"
      />
      <img
        src={control_1p}
        alt="contral_1p"
        className={`stage5_control_1p ${isVisible_1p ? "visible" : ""}`}
      />
      <img
        src={control_2p}
        alt="contral_2p"
        className={`stage5_control_2p ${isVisible_2p ? "visible" : ""}`}
      />
      <img src={bgImage} alt="bg" className="stage5-bgImage" />
    </div>
  );
}
